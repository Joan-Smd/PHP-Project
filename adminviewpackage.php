        ...
        <?php
				...
				if($rs)
				{
					if(mysqli_num_rows($rs))
					{
						...
						?>
        <tr>
          <th scope="row"><div><?php echo $row['id']; ?></div></th>
          <td><div><?php echo $row['name']; ?></div></td>
          <td><div><img src="image/<?php echo $row['image1']; ?>" width="100" height="100"> </div></td>
          <td><div><?php echo $row['place']; ?></div></td>
          <td><div><?php echo $row['service']; ?></div></td>
          <td><div><?php echo $row['guide']; ?></div></td>
          <td><div><?php echo $row['pricead']; ?></div></td>
          <td><div><?php echo $row['pricech']; ?></div></td>

          <td>
					      	<form action="aedit.php" method="post">
					      		<input type="hidden" name="edit_id" value=" <?php echo $row['id']; ?>">
					      	<button class="btn btn-primary badge rounded-pill bg-primary" name="edit_btn" style="width: 80px;">Edit</button>
					      	</form>
					      </td>
                <td>
